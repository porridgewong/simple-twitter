...
class FriendshipApiTests(TwitterTestCase):
    ...
    def test_follow(self):
        ...
        self.assertEqual(response.status_code, 201)
        self.assertEqual(FriendshipService.get_following_count(self.linghu.id), count + 1)
    ...
    def test_unfollow(self):
        ...
        count = FriendshipService.get_following_count(from_user_id=self.dongxie.id)
        response = self.dongxie_client.post(url)
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.data['deleted'], 1)
        self.assertEqual(FriendshipService.get_following_count(from_user_id=self.dongxie.id), count - 1)
        ...
        self.assertEqual(FriendshipService.get_following_count(from_user_id=self.dongxie.id), count)
